...
import { SupabaseUserGlobalContext } from "./SupabaseUserGlobalContext";  // plasmic-import: 7mrZ7EuxJSFV/codeComponent
import { CompL6Kf3DvDvag9 } from "./CompL6Kf3DvDvag9";  // plasmic-import: L6kf3dvDvag9/codeComponent
...
globalVarsProviderProps?: Partial<
           Omit<React.ComponentProps<typeof CompL6Kf3DvDvag9>, "children">>;
    }
...
colorPrimary={(antdConfigProviderProps && "colorPrimary" in antdConfigProviderProps) ? antdConfigProviderProps.colorPrimary! : "#327CE4"}
...
removeLoading={(antdConfigProviderProps && "removeLoading" in antdConfigProviderProps) ? antdConfigProviderProps.removeLoading! : false}
...
wireframe={(antdConfigProviderProps && "wireframe" in antdConfigProviderProps) ? antdConfigProviderProps.wireframe! : false}
      ...
      {...supabaseUserGlobalContextProps}
      defaultRedirectOnLoginSuccess={(supabaseUserGlobalContextProps && "defaultRedirectOnLoginSuccess" in supabaseUserGlobalContextProps) ? supabaseUserGlobalContextProps.defaultRedirectOnLoginSuccess! : ``}
      >
        
      <CompL6Kf3DvDvag9
      {...globalVarsProviderProps}
      initialLoggedIn={(globalVarsProviderProps && "initialLoggedIn" in globalVarsProviderProps) ? globalVarsProviderProps.initialLoggedIn! : false}
initialTheme={(globalVarsProviderProps && "initialTheme" in globalVarsProviderProps) ? globalVarsProviderProps.initialTheme! : "light"}
initialUserName={(globalVarsProviderProps && "initialUserName" in globalVarsProviderProps) ? globalVarsProviderProps.initialUserName! : "Guest"}
      >
        { children }
      </CompL6Kf3DvDvag9>
