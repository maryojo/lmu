...
import sty from "./PlasmicAllStudents.module.css"; // plasmic-import: KdayVLNujOgG/css

createPlasmicElementProxy;

export type PlasmicAllStudents__VariantMembers = {};
export type PlasmicAllStudents__VariantsArgs = {};
type VariantPropType = keyof PlasmicAllStudents__VariantsArgs;
export const PlasmicAllStudents__VariantProps = new Array<VariantPropType>();

export type PlasmicAllStudents__ArgsType = {};
type ArgPropType = keyof PlasmicAllStudents__ArgsType;
export const PlasmicAllStudents__ArgProps = new Array<ArgPropType>();
...
export interface DefaultAllStudentsProps {}
...
function PlasmicAllStudents__RenderFunc(props: {
  variants: PlasmicAllStudents__VariantsArgs;
  args: PlasmicAllStudents__ArgsType;
  overrides: PlasmicAllStudents__OverridesType;
  forNode?: string;
}) {
        ...
        >
          <DataCtxReader__>
            {$ctx => (
              <React.Fragment>
                <div
                  className={classNames(projectcss.all, sty.freeBox___2Wjex)}
                >
                  <div
                  ...
                  >
                    ...
                    {(() => {
                      const child$Props = {
                        ...
                        data: (() => {
                          try {
                            return $ctx.globalStudentsData?.data;
                          } catch (e) {
                            if (
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicAllStudents__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicAllStudents__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicAllStudents__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicAllStudents__ArgProps,
          internalVariantPropNames: PlasmicAllStudents__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicAllStudents__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicAllStudents";
  } else {
    func.displayName = `PlasmicAllStudents.${nodeName}`;
  }
  return func;
}

export const PlasmicAllStudents = Object.assign(
  // Top-level PlasmicAllStudents renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicAllStudents
    internalVariantProps: PlasmicAllStudents__VariantProps,
    internalArgProps: PlasmicAllStudents__ArgProps,
...
export default PlasmicAllStudents;
/* prettier-ignore-end */
