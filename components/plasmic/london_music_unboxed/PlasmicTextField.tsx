...
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: UlE2KW6T6NZS/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: k-Qv5DzxGbDH/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__pc3W5, {
          [sty.freeBoxiconEnd__pc3W5STdn8]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__pc3W59DAD]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__pc3W5Dw5]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__oYnsn, {
            [sty.freeBoxiconStart__oYnsn9DAD]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__oYnsNdw5]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__fov6G)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__vSvYz, {
            [sty.freeBoxiconEnd__vSvYzsTdn8]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__vSvYz9DAD]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___9Dmfb)}
                role={"img"}
              />
            ),
