...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: TM1IOUI2mayj/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__zdpXo)}>
        <div className={classNames(projectcss.all, sty.freeBox__byBTk)} />
      </div>
      {renderPlasmicSlot({
